...
from ppo.cnn import CNNActor, CNNBase, CNNCritic
...
if __name__ == '__main__':
  ...
  policy_model_fn = lambda nA: CNNActor(num_stack=num_stack, output_dim=nA)
  ...
  value_model_fn = lambda : CNNCritic(num_stack=num_stack)
