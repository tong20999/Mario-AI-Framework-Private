...
def get_make_env_fn(**kargs):
    def make_env_fn(env_name, seed=None, render=None, record=False,
                    ...
                    inner_wrappers=None, outer_wrappers=None) -> gym.Env:
...
class PER():
    ...
    def interaction_step(self, state, env:gym.Env):
    ...
    def train(self, make_env_fn, make_env_kargs, seed, gamma, 
        ...
        env:gym.Env = self.make_env_fn(**self.make_env_kargs, seed=self.seed)
    ...
    def evaluate(self, eval_policy_model, eval_env:gym.Env, n_episodes=1):
        rs = []
