...
public class MarioGamePy4j {
     ...
     */
    public MarioResult runGame(MarioAgentPy4j agent, String level, int timer) {
     ...
     * @return statistics about the current game
     */
    public MarioResult runGame(MarioAgentPy4j agent, String level, int timer, int marioState) {
     ...
     * @return statistics about the current game
     */
    public MarioResult runGame(MarioAgentPy4j agent, String level, int timer, int marioState, boolean visuals) {
     ...
     * @return statistics about the current game
     */
    public MarioResult runGame(MarioAgentPy4j agent, String level, int timer, int marioState, boolean visuals, int fps) {
